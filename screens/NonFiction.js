...
const NonFiction = ({ route }) => {
  const { fictionBooks, nonfictionBooks, scienceBooks, historyBooks, romanceBooks } = route.params;
  ...
  return (
    <ScrollView style={styles.container}>
      <Animated.View style={[styles.welcomeContainer, { marginTop: marginTopAnimation }]}>
        <Text style={styles.welcomeText}>Welcome to Non-Fiction Section</Text>
      </Animated.View>
      <View style={styles.section}>
        <ScrollView horizontal>
          ...
          >
            <Text style={[styles.categoryText, styles.selectedCategoryText]}>Non-Fiction</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.category}
